    ...
    function EpG(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrdersPage = /*#__PURE__*/function () {
        function OrdersPage(api, util, router) {
          ...
          this.util.getOrder().subscribe(function (data) {
        ...
        _createClass(OrdersPage, [{
          ...
          key: "goToOrderDetail",
          value: function goToOrderDetail(item) {
            console.log(item);
            var navData = {
              queryParams: {
                id: item
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_apis_service__WEBPACK_IMPORTED_MODULE_4__["ApisService"], src_app_services_util_service__WEBPACK_IMPORTED_MODULE_5__["UtilService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]])], OrdersPage);
      /***/
    },
