  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-register-register-module"], {
    ...
    function gnlj(module, __webpack_exports__, __webpack_require__) {
      ...
      */
      ...
      var RegisterPage = /*#__PURE__*/function () {
        ...
        _createClass(RegisterPage, [{
          ...
          value: function emailValidation() {
            ...
            this.isLogin = true; // this.api.checkEmail(this.user.email).then((datas: any) => {
            //   this.isLogin = false;
            //   if (!datas.length) {
            //     this.goNext();
            //   } else {
          ...
          value: function submit() {
            this.isLogin = true; // this.api.register(this.user.email, this.user.password, this.user.first_name, this.user.last_name).then((data) => {
            //   console.log(data);
            //   this.isLogin = false;
            //   if (data && data.uid) {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_5__["Location"], src_app_services_util_service__WEBPACK_IMPORTED_MODULE_6__["UtilService"], src_app_services_apis_service__WEBPACK_IMPORTED_MODULE_7__["ApisService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"]])], RegisterPage);
      /***/
    }
  }]);
})();
